...
using BalleBalleDhaba.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "BalleBalleDhaba", Version = "v1" });
...
//Inject context
builder.Services.AddTransient<BalleBalleDhabaContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "BalleBalleDhaba API v1");
