...
using BalleBalleDhaba.Entities;

namespace BalleBalleDhaba.Data
{
    public class BalleBalleDhabaContext : DbContext
    {
        protected override void OnConfiguring(Microsoft.EntityFrameworkCore.DbContextOptionsBuilder optionsBuilder)
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-7723PEB\\SQLEXPRESS;Initial Catalog=T631688_Balle_Balle_Dhaba;Persist Security Info=True;user id=sa;password=qwerty123;Integrated Security=false;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=true;");
        }
