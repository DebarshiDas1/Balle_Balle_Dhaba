...
using BalleBalleDhaba.Models;
using BalleBalleDhaba.Data;
using BalleBalleDhaba.Filter;
using BalleBalleDhaba.Entities;
using BalleBalleDhaba.Authorization;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.JsonPatch;
using System.Linq.Expressions;

namespace BalleBalleDhaba.Controllers
{
    /// <summary>
    ...
    {
        private readonly BalleBalleDhabaContext _context;

        public RoleEntitlementController(BalleBalleDhabaContext context)
        {
            _context = context;
        }
